...
# Abstract
I replicate "What the Demolition of Public Housing Teaches Us about the Impact of Racial Threat on Political Behavior” (@enos_paper) using data and code provided by the creators of (@enos_paper) which can be found in their relevant Harvard Dataverse directory (@enos_data). Currently, there are 6 figures with figures 4 and 5 consistenting of 2 sub-figures. At present, I am unable to replicate table 1 in the original paper in this replication because I was unable to find the relevant dataset in the Dataverse.
